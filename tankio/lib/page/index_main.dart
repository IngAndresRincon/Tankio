...
class _MainPageState extends ConsumerState<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final balanceValue =
        (user.userLogin?.info.balance?.balance ?? 0).toDouble();
    return PopScope(
      canPop: false,
      child: Scaffold(
                      ...
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: IconButton(
                              onPressed: () {
                                // Navigator.pushNamed(context, '/tankio-schedule');
                              },
                              icon: Icon(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Text(
                                          "\$ ${formatMoney(item.programmingMoney)}",
                                          style: TextStyle(
                                            fontFamily: 'Nunito',
                                            fontWeight: FontWeight.w800,
                                            color: Colors.black,
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              ...
                                              fontWeight: FontWeight.w800,
                                              color:
                                                  item.programmingStatusId == 3
                                                  ? Colors.green.shade200
                                                  : item.programmingStatusId ==
                                                        2
