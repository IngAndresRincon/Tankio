...
class StationProvider extends ChangeNotifier {
  ...
  void speedButton({required String value}) {
    try {
      controllerAmountRecharge.text = formatMoney(parseMoney(value));
    } catch (e) {
      debugPrint(e.toString());
    } finally {
      notifyListeners();
  ...
  void validateValueField({required String value}) {
    try {
      ...
      controllerAmountRecharge.text = normalizeMoneyInput(value);
    } catch (e) {
      debugPrint(e.toString());
    } finally {
      notifyListeners();
  ...
  Future<bool> createPaymentGateway() async {
    ...
    try {
      ...
      final double totalAmount =
          parseMoney(controllerAmountRecharge.text) +
