...
class _InselectScheduleState extends ConsumerState<InselectSchedule> {
  ...
  void initLoad() async {
    await Future.microtask(() async {
      await ref.read(vehicleProvider).getListVehicleByUserId(validEnable: true);
                    ...
                    items: inselect.listDispenserPosition
                        .map<DropdownMenuItem<String>>((e) {
                          return DropdownMenuItem(
                            ...
                            child: Text(
                               "${e.hoseNumber}-${e.product.toUpperCase()} - ${e.symbol}${formatMoney(e.price)} ${e.currency}",
                              style: TextStyle(
                                fontFamily: 'Nunito',
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              "\$ ${formatMoney(parseMoney(inselect.moneyCalculate))}",
                              style: TextStyle(
                                fontFamily: 'Nunito',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              "\$ ${inselect.productSelected == null ? '' : formatMoney(inselect.productSelected!.price)}",
                              style: TextStyle(
                                fontFamily: 'Nunito',
                                fontSize: size.width * 0.041,
                                color: Colors.black,
