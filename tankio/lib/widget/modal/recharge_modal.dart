...
class RechargeModal extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final amountValue = parseMoney(station.controllerAmountRecharge.text);
    final transactionFee =
        station.selectedPaymentGateway?.transactionFee ?? 0;
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    Text(
                      '\$ ${formatMoney(user.userLogin?.info.balance?.balance ?? 0)}',
                      style: TextStyle(
                        fontFamily: 'Nunito',
                    ...
                    Text(
                          "\$ ${formatMoney(station.selectedPaymentGateway?.transactionFee ?? 0)}",
                          style: TextStyle(
                            fontFamily: 'Nunito',
