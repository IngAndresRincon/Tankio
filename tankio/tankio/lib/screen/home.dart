  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        await LogoutConfirmationModal.show(
          context: context,
          onConfirm: () async {
            ...
            Navigator.of(
              context,
            ).pushNamedAndRemoveUntil('/login_biometric', (route) => false);
          },
        );
      },
      child: Scaffold(
        body: PageView(
          controller: home.controllerPage,
        ...
        bottomNavigationBar: SafeArea(
          ...
          child: Container(
            ...
            child: BottomNavigationBar(
              ...
              currentIndex: home.indexPage,
              onTap: (value) async {
                setState(() {
                  home.indexPage = value == 2 ? value + 1 : value;
                });
                if (home.indexPage == 1) {
