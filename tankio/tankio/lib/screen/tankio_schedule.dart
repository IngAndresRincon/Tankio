            ...
            DropdownButtonFormField<String>(
              ...
              items: tankio.listDispenserPosition.map<DropdownMenuItem<String>>((
                ...
                return DropdownMenuItem(
                  ...
                  child: Text(
                    "${e.product.toUpperCase()} - ${e.symbol}${moneyFormat.format(e.price)} ${e.currency}",
                    style: TextStyle(
                      fontFamily: 'Nunito',
                      fontSize: size.width * 0.036,
                      fontWeight: FontWeight.w500,
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        "\$ ${moneyFormat.format(num.tryParse(tankio.moneyCalculate) ?? 0)}",
                        style: TextStyle(
                          fontFamily: 'Nunito',
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        "\$ ${moneyFormat.format(tankio.productSelected == null ? 0 : tankio.productSelected!.price)}",
                        style: TextStyle(
                          fontFamily: 'Nunito',
                          fontSize: size.width * 0.041,
                          color: Colors.black,
