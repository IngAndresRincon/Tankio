...
import 'package:tankio/widget/modal/stop_charging_confirmation_modal.dart';
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  trailing: Text(
                    "\$ ${moneyFormat.format(inselect.estimatedCost)}",
                    style: TextStyle(
                      fontFamily: 'Nunito',
                      fontSize: size.width * 0.041,
                      fontWeight: FontWeight.w800,
                ...
                ElevatedButton(
                  onPressed:
                      ...
                      ? null
                      : () {
                          StopChargingConfirmationModal.show(
                            context: context,
                            onConfirm: () async {
                              final uuid = inselect.uuidProgramming ?? "";
                              await inselect.changeStatusProgramming(
                                uuid,
                                8,
                              );
